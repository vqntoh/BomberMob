...
public class Bomber extends EntityZombie {
    public static final String BOMBER_KEY = "BomberMob";
    ...
    public Bomber(Location location) {
        ...
        getBukkitEntity().getPersistentDataContainer().set(new NamespacedKey(BomberMob.getInstance(), BOMBER_KEY), PersistentDataType.STRING, BOMBER_KEY);
